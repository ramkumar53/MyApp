    ...
    private void showEmployee(){
        ...
        try {
            ...
            for(int i = 0; i<result.length(); i++){
                ...
                employees.put(Config.TAG_TOTAL,total);
        ...
        ListAdapter adapter = new SimpleAdapter(
                ViewAllEmployee.this, list, R.layout.list_item2,
                new String[]{Config.TAG_ID,Config.TAG_NAME,Config.TAG_TOTAL},
                new int[]{R.id.name1, R.id.name,R.id.total});
