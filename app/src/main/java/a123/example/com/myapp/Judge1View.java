...
public class Judge1View extends AppCompatActivity implements ListView.OnItemClickListener {
    ...
    private void showEmployee(){
        ...
        ListAdapter adapter = new SimpleAdapter(
                Judge1View.this, list, R.layout.list_item,
    ...
    private void getJSON(){
        class GetJSON extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(Judge1View.this,"Fetching Data","Wait...",false,false);
            }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        Intent intent = new Intent(this,Judge1Edit.class);
