...
public class Judge1Edit extends AppCompatActivity implements View.OnClickListener{
    ...
    private void getEmployee(){
        class GetEmployee extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(Judge1Edit.this,"Fetching...","Wait...",false,false);
            }
    ...
    private void updateEmployee(){
        ...
        final String j1indro =editText3.getText().toString().trim();
        final String j1content= editText4.getText().toString().trim();
        final String j1knowledge =editText5.getText().toString().trim();
        final String j1query = editText6.getText().toString().trim();
        final String j1total = j1indro+j1content+j1knowledge+j1query;
        final String j2indro = toString().trim();
        final String j2content= toString().trim();
        final String j2knowledge = toString().trim();
        final String j2query = toString().trim();
        ...
        class UpdateEmployee extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(Judge1Edit.this,"Updating...","Wait...",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                super.onPostExecute(s);
                loading.dismiss();
                Toast.makeText(Judge1Edit.this,s,Toast.LENGTH_LONG).show();
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                String s = rh.sendPostRequest(Config.URL_UPDATE_EMP1 ,hashMap);
        ...
        alertDialogBuilder.setPositiveButton("Yes",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        deleteEmployee();
                        startActivity(new Intent(Judge1Edit.this,ViewAllEmployee.class));
                    }
                });
